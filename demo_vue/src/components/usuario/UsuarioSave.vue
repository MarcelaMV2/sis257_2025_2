...
import { Button, Checkbox, Dialog, Dropdown, InputText } from 'primevue'
  ...
  <div class="card flex justify-center">
    ...
    >
      ...
      <div class="flex items-center gap-4 mb-4">
        ...
        <InputText id="clave" v-model="usuario.clave" class="flex-auto" autocomplete="off" />
      </div>
      <div class="flex items-center gap-4 mb-4">
      ...
      <div class="flex align-items-center gap-3">
        <label for="premium" class="font-semibold w-6rem">Premium</label>
        <Checkbox id="premium" v-model="usuario.premium" binary />
      </div>
