...
<template>
  <div>
    ...
    >
      ...
      <Column field="genero.descripcion" header="Genero" sortable style="width: 50px"></Column>
      <Column field="duracion" header="Duracion" sortable style="width: 50px"></Column>
    ...
    <!-- <table v-if="false"> ocult el contenido de la tabla-->
    <table v-if="false">
      <thead>
        <tr>
          <th>Nro.</th>
